...
- [x] Phase 1b: Write generate_build.go for internal/wasm/ that compiles to search.wasm and generates JS glue.
- [x] Phase 1a: Create internal/wasm/ package with index types, search context, and WASM exports. Build with TinyGo.
- [x] Phase 5: Playwright integration test: open static artifact over file://, verify search, navigation, xref. Update README.
